...
import expend.human.Employee;
import expend.human.Human;
import expend.human.Student;
...
public class Extend01 {
	public static void main(String[] args) {
		...
		System.out.println("Employeeクラスのメソッド:プロフィールを紹介します。" + tanaka.getEmployeeProfiile());
